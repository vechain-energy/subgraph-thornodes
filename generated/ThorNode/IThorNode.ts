...
export class IThorNode__getTokenParamsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class IThorNode__getMetadataResult {
  value0: Address;
  value1: i32;
  value2: boolean;
  value3: boolean;
...
export class IThorNode extends ethereum.SmartContract {
  static bind(address: Address): IThorNode {
    return new IThorNode("IThorNode", address);
  }
  ...
  getTokenParams(_level: i32): IThorNode__getTokenParamsResult {
    let result = super.call(
      "getTokenParams",
    ...
    return new IThorNode__getTokenParamsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getTokenParams(
    _level: i32,
  ): ethereum.CallResult<IThorNode__getTokenParamsResult> {
    let result = super.tryCall(
      "getTokenParams",
      "getTokenParams(uint8):(uint256,uint64,uint64,uint64)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(_level))],
    ...
    return ethereum.CallResult.fromValue(
      new IThorNode__getTokenParamsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getMetadata(_tokenId: BigInt): IThorNode__getMetadataResult {
    let result = super.call(
      "getMetadata",
    ...
    return new IThorNode__getMetadataResult(
      result[0].toAddress(),
      result[1].toI32(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_getMetadata(
    _tokenId: BigInt,
  ): ethereum.CallResult<IThorNode__getMetadataResult> {
    let result = super.tryCall(
      "getMetadata",
      "getMetadata(uint256):(address,uint8,bool,bool,uint64,uint64,uint64)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IThorNode__getMetadataResult(
        value[0].toAddress(),
        value[1].toI32(),
        value[2].toBoolean(),
        value[3].toBoolean(),
